...
-- Mac-like modifiers: Caps Lock is Ctrl, and Left Alt / Left Super are swapped
-- so Super sits next to Space like Cmd. The Copilot key is remapped to Ctrl by
-- keyd (/etc/keyd/default.conf), since it sends a chord XKB can't remap.
hl.config({
  input = {
